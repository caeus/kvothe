package io.sower.syntax

import scala.language.{higherKinds, reflectiveCalls}
import scala.util.{Failure, Success, Try}

import cats.arrow.FunctionK
import io.sower.{BranchReq, BranchSelector, Pipe, Sower}

package object syntax {

  trait SowerWithSyntax[F[_], Input, Output] {
    ...
    object syntax{
      ...
      val asString: Pipe[Option[String], Try[String]] = Pipe[Option[String], Try[String]] {
